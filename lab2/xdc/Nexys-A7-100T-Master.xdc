...
# Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { CLK50 }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { key[2] }]; #IO_L12P_T1_MRCC_14 Sch=btnl
